...
def build_ProposedModel(X_inputs, configs, max_sentnum, max_sentlen, num_item, num_category, vocab_size, latent_dim, inf_mask, beta_mask, weights=None):
    ...
    theta = layers.Dense(latent_dim, name='theta', activity_regularizer=regularizers.l2(0.01))(x)
